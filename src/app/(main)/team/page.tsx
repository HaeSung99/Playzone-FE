...
import { getTeamMembers } from '@/data/site';
                    ...
                    >
                      <div className="aspect-w-3 aspect-h-2 w-full flex items-center justify-center">
                        {member.image ? (
                          ...
                          <div className="w-40 h-40 bg-gray-200 rounded-full mx-auto mt-8 mb-4 flex items-center justify-center">
                            <span className="text-gray-400 text-xs text-center px-2">이미지 영역</span>
                          </div>
                        )}
                      </div>
