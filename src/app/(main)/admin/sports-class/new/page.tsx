...
export default function NewSportsClassPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await adminCreateSportsClass(body);
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-800">스포츠 클래스 추가</h1>
      </div>
